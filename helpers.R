...
# helpers.R — generic helpers that won't collide with your numeric_vars vector

# return numeric columns (as names)
get_numeric_vars <- function(d) {
  names(d)[sapply(d, is.numeric)]
}

# return categorical-ish columns
get_categorical_vars <- function(d) {
